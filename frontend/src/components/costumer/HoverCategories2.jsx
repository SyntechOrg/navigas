...
const items = [
  { title: "Mid Term", src: "/images/suv.png", text: "" },
  {
    title: "Long Term",
...
export default function HoverCategories2() {
  const [hoveredIndex, setHoveredIndex] = useState(null);

  return (
    <div className="grid lg:grid-cols-2 grid-cols-1 sm:grid-cols-2 container w-full overflow-y-visible h-full mx-auto  ">
      {items.map((item, i) => {
